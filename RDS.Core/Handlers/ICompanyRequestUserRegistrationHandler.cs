...
public interface ICompanyRequestUserRegistrationHandler
{
    ...
    Task<PagedResponse<List<CompanyRequestUserRegistration>>> GetAllAsync(
        GetAllCompaniesRequestUserRegistrationRequest request);

    Task<Response<CompanyRequestUserRegistration?>> GetByUserEmailAsync(
        GetCompanyRequestUserRegistrationByUserEmailRequest request);

    Task<Response<CompanyRequestUserRegistration?>> GetByConfirmationCodeAsync(
